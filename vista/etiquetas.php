...
<html>
    <head>
        ...
        <title> Estas son las Etiquetas</title>
    </head>
    <body>
        ...
        <label>opcion 3</label><input type="radio" name="grupo1">
        <br>


        <br>
        <label>opcion 1</label><input type="radio" name="grupo2">
        ...
        <!-- Type=DISC, CIRCLE y SQUARE -->
        <ul><!--NO ORGANIZADAS O NUMERADAS --> 
            <li>Camisas para Jos&eacute;</li> 
            <li>Loci&oacute;n para Daniel</li> 
        </ul>   

        <ol><!--ORGANIZADAS O NUMERADAS -->  
        ...
        <ol><!--ORGANIZADAS O NUMERADAS -->  
            ...
            <li type="i">Comprar Disco</li>         
            <li type="i">Asistir a la Universidad</li>        
        </ol>
        <ol>     
            <li type="a">Geometr&iacute;a</li> 
            <li type="a">ciencias Sociales</li> 
            <li type="a">Geometr&iacute;a</li>        
        </ol> 
    </body>
</html>
